...
__DEFINE__(1660392127441, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1660392127442,"./event-store":1660392127443}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660392127442, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1660392127443, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1660392127442,"./utils":1660392127444}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660392127444, function(require, module, exports) {
...
return __REQUIRE__(1660392127441);
})()
